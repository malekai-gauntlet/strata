        ...
        <StorySection id="opportunity" withGraphic customGraphic={
          ...
          <div className="max-w-2xl">
            ...
            <StreamingText className="text-xl text-gray-400 mb-6" delay={0.5} index={1}>
              {`This is a unique point in time. Training facilities can start their own microschools and double their income. This is only now possible because:

1. The new ESA legislation enables trainers to be paid at least $10,000 in revenue for each student enrolled at their school. Microschools have 15-25 students.
        ...
        <StorySection id="legacy" withGraphic customGraphic={
          ...
          <div className="max-w-2xl">
            ...
            <StreamingText className="text-xl text-gray-400 mb-8" index={1}>
              {`This is a golden opportunity for top sports trainers to expand their impact and blaze their own trail.
...
\nWe're a team of AI engineers, so automating away tedious, outdated practices is our top skillset. From checking zoning, filing paperwork, to securing ESA funding — the Strata team handles that all.`}
            </StreamingText>
          </div>
        </StorySection>

        <StorySection id="start">
          <div className="max-w-2xl">
            <StreamingText tag="h2" className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6" index={0}>
              Time to start your school and form your legacy.
            </StreamingText>
            <StreamingText 
            ...
            <div className="flex flex-col gap-4">
              <form 
                ...
                onSubmit={(e) => {
                  ...
                  formData.append('source', 'training_page');
